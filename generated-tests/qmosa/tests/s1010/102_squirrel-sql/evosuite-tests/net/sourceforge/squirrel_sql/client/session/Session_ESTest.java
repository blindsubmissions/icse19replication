...
public class Session_ESTest extends Session_ESTest_scaffolding {
  ...
  */
  ...
  public void test0()  throws Throwable  {
      ...
      IntegerIdentifier integerIdentifier0 = new IntegerIdentifier((-3084));
      ...
      connectionWrapper0.closeAnyOpenStatements();
      Session session0 = null;
      try {
        session0 = new Session((IApplication) null, sQLDriver0, sQLAlias0, sQLConnection0, "SessionManager.getNextSession()-> Returning first session", "SessionManager.getNextSession()-> Returning first session", integerIdentifier0);
