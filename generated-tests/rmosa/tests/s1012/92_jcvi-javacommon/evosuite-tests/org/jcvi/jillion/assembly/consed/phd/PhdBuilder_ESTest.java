...
public class PhdBuilder_ESTest extends PhdBuilder_ESTest_scaffolding {
  ...
  */
  ...
  public void test02()  throws Throwable  {
      NucleotideSequence nucleotideSequence0 = mock(NucleotideSequence.class, new ViolatedAssumptionAnswer());
      doReturn(2487L).when(nucleotideSequence0).getLength();
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      ...
      hashMap0.values();
      hashMap0.putIfAbsent("", "sequence can not be null");
  ...
  */
  ...
  public void test03()  throws Throwable  {
      ...
      DefaultPhd defaultPhd0 = new DefaultPhd("", nucleotideSequence1, qualitySequence1, positionSequence0, map0);
      String string2 = "ncD-5XA_P4z}tvN_";
      long long0 = (-1L);
      // Undeclared exception!
      try { 
        Range.ofLength((-1L));
  ...
  */
  ...
  public void test04()  throws Throwable  {
      ...
      QualitySequence qualitySequence1 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      ArtificialPhd artificialPhd0 = new ArtificialPhd("s8(E9tl^IU", nucleotideSequence1, qualitySequence1, 15);
      ...
      ArtificialPhd.createNewbler454Phd("mR/'&hss7S&nG>Dl", nucleotideSequence3, qualitySequence3, (Map<String, String>) hashMap0, (List<PhdWholeReadItem>) linkedList0);
      ArtificialPhd.createNewbler454Phd((String) null, nucleotideSequence2, qualitySequence2, (Map<String, String>) null);
      // Undeclared exception!
      try { 
  ...
  */
  ...
  public void test05()  throws Throwable  {
      NucleotideSequence nucleotideSequence0 = mock(NucleotideSequence.class, new ViolatedAssumptionAnswer());
      doReturn(2235L).when(nucleotideSequence0).getLength();
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(2235L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("IsB", nucleotideSequence0, qualitySequence0);
      NucleotideSequence nucleotideSequence1 = mock(NucleotideSequence.class, new ViolatedAssumptionAnswer());
      doReturn(2613L).when(nucleotideSequence1).getLength();
      QualitySequence qualitySequence1 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      ArtificialPhd artificialPhd0 = ArtificialPhd.createNewbler454Phd("IsB", nucleotideSequence1, qualitySequence1);
      NucleotideSequence nucleotideSequence2 = mock(NucleotideSequence.class, new ViolatedAssumptionAnswer());
      QualitySequence qualitySequence2 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      PositionSequence positionSequence0 = artificialPhd0.getPositionSequence();
      DefaultPhd defaultPhd0 = new DefaultPhd("IsB", nucleotideSequence2, qualitySequence2, positionSequence0);
      List<PhdWholeReadItem> list0 = defaultPhd0.getWholeReadItems();
      phdBuilder0.wholeReadItems(list0);
      NucleotideSequence nucleotideSequence3 = mock(NucleotideSequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(nucleotideSequence3).getLength();
      QualitySequence qualitySequence3 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      ArtificialPhd artificialPhd1 = new ArtificialPhd("MNzA}2&[.W;?ockB", nucleotideSequence3, qualitySequence3, 3726);
      // Undeclared exception!
      try { 
  ...
  */
  ...
  public void test07()  throws Throwable  {
      ...
      PhdBuilder phdBuilder0 = null;
      try {
        phdBuilder0 = new PhdBuilder("qualities can not be null", (NucleotideSequence) null, qualitySequence1);
        fail("Expecting exception: NullPointerException");
  ...
  */
  ...
  public void test08()  throws Throwable  {
      ...
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(0L).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = new PhdBuilder("zc\" !Lq':8?'OE$xzT}", nucleotideSequence0, qualitySequence0);
      int int0 = 87;
      // Undeclared exception!
      try { 
        phdBuilder0.fakePeaks(87, (-1258));
        fail("Expecting exception: IllegalArgumentException");
  ...
  */
  ...
  public void test11()  throws Throwable  {
      ...
      PhdBuilder phdBuilder0 = null;
      try {
        phdBuilder0 = new PhdBuilder("OA<H", nucleotideSequence0, (QualitySequence) null);
        fail("Expecting exception: NullPointerException");
  ...
  */
  ...
  public void test13()  throws Throwable  {
      NucleotideSequence nucleotideSequence0 = mock(NucleotideSequence.class, new ViolatedAssumptionAnswer());
      doReturn(1248L).when(nucleotideSequence0).getLength();
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn((-3038L)).when(qualitySequence0).getLength();
      PhdBuilder phdBuilder0 = null;
      try {
        phdBuilder0 = new PhdBuilder("org.jcvi.jillion.internal.trace.chromat.DefaultChannel", nucleotideSequence0, qualitySequence0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  */
  ...
  public void test16()  throws Throwable  {
      ...
      doReturn(2487L).when(nucleotideSequence0).getLength();
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(2487L).when(qualitySequence0).getLength();
      HashMap<String, String> hashMap0 = new HashMap<String, String>();
      ArtificialPhd artificialPhd0 = ArtificialPhd.createNewbler454Phd("", nucleotideSequence0, qualitySequence0, (Map<String, String>) hashMap0);
      PhdBuilder phdBuilder0 = new PhdBuilder(artificialPhd0);
      PositionSequence positionSequence0 = artificialPhd0.getPositionSequence();
  ...
  */
  ...
  public void test17()  throws Throwable  {
      NucleotideSequence nucleotideSequence0 = mock(NucleotideSequence.class, new ViolatedAssumptionAnswer());
      QualitySequence qualitySequence0 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      doReturn(2235L, 0L).when(qualitySequence0).getLength();
      NucleotideSequence nucleotideSequence1 = mock(NucleotideSequence.class, new ViolatedAssumptionAnswer());
      doReturn(2613L).when(nucleotideSequence1).getLength();
      QualitySequence qualitySequence1 = mock(QualitySequence.class, new ViolatedAssumptionAnswer());
      ArtificialPhd artificialPhd0 = ArtificialPhd.createNewbler454Phd("IsB", nucleotideSequence1, qualitySequence1);
