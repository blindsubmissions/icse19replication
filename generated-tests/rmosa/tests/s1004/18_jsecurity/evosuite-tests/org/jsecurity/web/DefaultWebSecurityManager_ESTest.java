...
public class DefaultWebSecurityManager_ESTest extends DefaultWebSecurityManager_ESTest_scaffolding {
  ...
  */
  ...
  public void test03()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        defaultWebSecurityManager0.setSessionIdCookieName("toLevel");
        fail("Expecting exception: IllegalStateException");
  ...
  */
  ...
  public void test04()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        defaultWebSecurityManager0.setSessionIdCookiePath("k%4O'{%LS9xTjz0");
        fail("Expecting exception: IllegalStateException");
  ...
  */
  ...
  public void test06()  throws Throwable  {
      SimpleAccountRealm simpleAccountRealm0 = new SimpleAccountRealm();
      SimpleAccountRealm simpleAccountRealm1 = new SimpleAccountRealm("JxjzU<^j4(RzIo3");
  ...
  */
  ...
  public void test09()  throws Throwable  {
      ...
      stringArray0[6] = "jsecurity";
      try { 
        defaultWebSecurityManager0.checkPermissions((PrincipalCollection) null, stringArray0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // Subject does not have permission [org.jsecurity.web.DefaultWebSecurityManager_PRINCIPALS_SESSION_KEY]
         //
  ...
  */
  ...
  public void test12()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        defaultWebSecurityManager0.setSessionMode("net.sf.ehcache.config.BeanHandler");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Invalid sessionMode [net.sf.ehcache.config.BeanHandler].  Allowed values are public static final String constants in the org.jsecurity.web.DefaultWebSecurityManager class: 'http' or 'jsecurity', with 'http' being the default.
         //
         verifyException("org.jsecurity.web.DefaultWebSecurityManager", e);
      }
  }
  ...
  */
  ...
  public void test18()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/tmp");
      InetAddress inetAddress0 = MockInetAddress.getLocalHost();
      SimplePrincipalCollection simplePrincipalCollection0 = new SimplePrincipalCollection(evoSuiteFile0, ">vgC8+0N~p6surEW");
  ...
  */
  ...
  public void test19()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        defaultWebSecurityManager0.setSessionMode(".T&");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Invalid sessionMode [.T&].  Allowed values are public static final String constants in the org.jsecurity.web.DefaultWebSecurityManager class: 'http' or 'jsecurity', with 'http' being the default.
         //
         verifyException("org.jsecurity.web.DefaultWebSecurityManager", e);
      }
  }
