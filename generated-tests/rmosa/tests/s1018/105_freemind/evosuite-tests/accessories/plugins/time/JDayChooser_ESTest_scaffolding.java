...
public class JDayChooser_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.text.Format$Field", false, JDayChooser_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.time.temporal.TemporalQuery", false, JDayChooser_ESTest_scaffolding.class.getClassLoader()));
