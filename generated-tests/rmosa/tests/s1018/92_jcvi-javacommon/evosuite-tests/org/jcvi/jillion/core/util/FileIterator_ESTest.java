...
public class FileIterator_ESTest extends FileIterator_ESTest_scaffolding {
  ...
  */
  ...
  public void test00()  throws Throwable  {
      MockFile mockFile0 = new MockFile("G@BV2");
  ...
  */
  ...
  public void test12()  throws Throwable  {
      MockFile mockFile0 = new MockFile("_jrlI_ r_^-UxQP", "_jrlI_ r_^-UxQP");
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createBreadthFirstFileIteratorBuilder(mockFile0);
      MockFile.createTempFile("_jrlI_ r_^-UxQP", "_jrlI_ r_^-UxQP", (File) mockFile0);
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder1 = fileIterator_FileIteratorBuilder0.includeDirectories(true);
      FileFilter[] fileFilterArray0 = new FileFilter[25];
      LinkedList<FileFilter> linkedList0 = new LinkedList<FileFilter>();
      MultipleFileFilter multipleFileFilter0 = new MultipleFileFilter(linkedList0);
      ...
      MockFile mockFile1 = new MockFile("_jrlI_ r_^-UxQP");
  ...
  */
  ...
  public void test15()  throws Throwable  {
      MockFile mockFile0 = new MockFile("");
      MockFile.createTempFile("sl/", "", (File) mockFile0);
      FileIterator.createNonRecursiveFileIteratorBuilder(mockFile0);
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createNonRecursiveFileIteratorBuilder(mockFile0);
      fileIterator_FileIteratorBuilder0.build();
      FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.build();
  ...
  */
  ...
  public void test18()  throws Throwable  {
      MockFile mockFile0 = new MockFile("");
      MockFile.createTempFile("]r6m)1FldB,4$<[1", "", (File) mockFile0);
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createDepthFirstFileIteratorBuilder(mockFile0);
      FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.build();
      assertTrue(fileIterator0.hasNext());
  }
  ...
  */
  ...
  public void test20()  throws Throwable  {
      ...
      MockFile.createTempFile("t-TeCK$", "\"o@O<hc}tVN&@(7s", (File) mockFile0);
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createNonRecursiveFileIteratorBuilder(mockFile0);
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder1 = fileIterator_FileIteratorBuilder0.includeDirectories(true);
  ...
  */
  ...
  public void test21()  throws Throwable  {
      MockFile mockFile0 = new MockFile("");
      MockFile.createTempFile("TMCzIcLyo", "TMCzIcLyo", (File) mockFile0);
      FileIterator.createNonRecursiveFileIteratorBuilder(mockFile0);
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createNonRecursiveFileIteratorBuilder(mockFile0);
      FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.build();
      fileIterator0.next();
  ...
  */
  ...
  public void test22()  throws Throwable  {
      MockFile mockFile0 = new MockFile(".'t,pTM<}}");
      MockFile.createTempFile(".'t,pTM<}}", ".'t,pTM<}}", (File) mockFile0);
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createNonRecursiveFileIteratorBuilder(mockFile0);
      FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.build();
      assertFalse(fileIterator0.hasNext());
  }
  ...
  */
  ...
  public void test23()  throws Throwable  {
      ...
      FileIterator.FileIteratorBuilder fileIterator_FileIteratorBuilder0 = FileIterator.createDepthFirstFileIteratorBuilder(mockFile0);
      FileIterator fileIterator0 = fileIterator_FileIteratorBuilder0.build();
      MockFile mockFile1 = new MockFile(mockFile0, "mCY/7");
