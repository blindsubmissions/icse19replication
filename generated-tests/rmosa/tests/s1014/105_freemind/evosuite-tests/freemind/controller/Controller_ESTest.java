...
public class Controller_ESTest extends Controller_ESTest_scaffolding {
  ...
  */
  ...
  public void test3()  throws Throwable  {
      JPasswordField jPasswordField0 = new JPasswordField("zV[Tzj;Sb6*]mysj,", 0);
      JEditorPane jEditorPane0 = new JEditorPane();
      Color color0 = jEditorPane0.getCaretColor();
      try { 
        Controller.showCommonJColorChooserDialog(jPasswordField0, "zV[Tzj;Sb6*]mysj,", color0);
  ...
  */
  ...
  public void test6()  throws Throwable  {
      ...
      jRadioButtonMenuItem0.createVolatileImage(0, 0);
      ContainerEvent containerEvent0 = new ContainerEvent(jRadioButtonMenuItem0, 0, jRadioButtonMenuItem0);
      // Undeclared exception!
      try { 
