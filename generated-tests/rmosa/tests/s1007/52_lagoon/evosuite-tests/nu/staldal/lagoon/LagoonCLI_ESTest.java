...
public class LagoonCLI_ESTest extends LagoonCLI_ESTest_scaffolding {
  ...
  */
  ...
  public void test04()  throws Throwable  {
      ...
      stringArray0[0] = "nu.staldal.lagoon.core.LagoonException.xml";
      LagoonCLI.main(stringArray0);
  ...
  */
  ...
  public void test05()  throws Throwable  {
      ...
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "xu{#n#8s*");
      String[] stringArray0 = new String[1];
      stringArray0[0] = "nu.staldal.xtree.NodeWithChildren";
      LagoonCLI.main(stringArray0);
      LagoonCLI.main(stringArray0);
      String[] stringArray1 = new String[2];
      stringArray1[1] = "aP08 e6V}gyV";
      LagoonCLI.main(stringArray1);
      LagoonCLI.main(stringArray0);
      String[] stringArray2 = new String[6];
      stringArray2[0] = "aP08 e6V}gyV";
      stringArray2[1] = "xu{#n#8s*";
  ...
  */
  ...
  public void test09()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("vR~r}0u4r,");
      FileSystemHandling.appendStringToFile(evoSuiteFile0, "targetURL");
      String[] stringArray0 = new String[1];
      stringArray0[0] = "vR~r}0u4r,";
      LagoonCLI.main(stringArray0);
      assertEquals(1, stringArray0.length);
  }
