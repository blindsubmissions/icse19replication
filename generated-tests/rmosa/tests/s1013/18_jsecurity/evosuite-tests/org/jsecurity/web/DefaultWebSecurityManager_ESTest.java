...
public class DefaultWebSecurityManager_ESTest extends DefaultWebSecurityManager_ESTest_scaffolding {
  ...
  */
  ...
  public void test01()  throws Throwable  {
      ...
      Integer integer1 = Integer.getInteger("~&E3d", integer0);
  ...
  */
  ...
  public void test03()  throws Throwable  {
      ...
      ServletRequest servletRequest0 = mock(ServletRequest.class, new ViolatedAssumptionAnswer());
      ServletRequestWrapper servletRequestWrapper0 = new ServletRequestWrapper(servletRequest0);
      servletRequestWrapper0.setAttribute("jsecurity", "http");
  ...
  */
  ...
  public void test05()  throws Throwable  {
      SimpleAccountRealm simpleAccountRealm0 = new SimpleAccountRealm("Tyt_w/X^XiyD!@R*2");
      DefaultWebSecurityManager defaultWebSecurityManager0 = new DefaultWebSecurityManager(simpleAccountRealm0);
  ...
  */
  ...
  public void test06()  throws Throwable  {
      ...
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "org.jsecurity.web.DefaultWebSecurityManager");
      DefaultWebSecurityManager defaultWebSecurityManager0 = new DefaultWebSecurityManager();
      // Undeclared exception!
      try { 
        defaultWebSecurityManager0.setSessionIdCookieMaxAge((-459));
        fail("Expecting exception: IllegalStateException");
  ...
  */
  ...
  public void test07()  throws Throwable  {
      EvoSuiteFile evoSuiteFile0 = new EvoSuiteFile("/tmp/jsecurity-ehcache");
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "The root logger cannot be set to null.");
      DefaultWebSecurityManager defaultWebSecurityManager0 = new DefaultWebSecurityManager();
      // Undeclared exception!
      try { 
        defaultWebSecurityManager0.setSessionIdCookieName("The root logger cannot be set to null.");
        fail("Expecting exception: IllegalStateException");
  ...
  */
  ...
  public void test08()  throws Throwable  {
      ...
      stringArray0[2] = "t9'>,W0`/'=";
      stringArray0[3] = "http";
      defaultWebSecurityManager0.setSessionIdCookiePath("t9'>,W0`/'=");
      stringArray0[4] = "";
      // Undeclared exception!
      try { 
  ...
  */
  ...
  public void test09()  throws Throwable  {
      ...
      FileSystemHandling.appendLineToFile(evoSuiteFile0, "The root logger cannot be set to null.");
      DefaultWebSecurityManager defaultWebSecurityManager0 = new DefaultWebSecurityManager();
      defaultWebSecurityManager0.setRememberMeCookiePath("The root logger cannot be set to null.");
      System.setCurrentTimeMillis(0L);
      // Undeclared exception!
      try { 
        defaultWebSecurityManager0.getSession("The root logger cannot be set to null.");
        fail("Expecting exception: IllegalStateException");
  ...
  */
  ...
  public void test17()  throws Throwable  {
      ...
      SimplePrincipalCollection simplePrincipalCollection0 = new SimplePrincipalCollection();
      ServletRequest servletRequest0 = mock(ServletRequest.class, new ViolatedAssumptionAnswer());
      doReturn("S9m4").when(servletRequest0).getRemoteHost();
      ServletRequestWrapper servletRequestWrapper0 = new ServletRequestWrapper(servletRequest0);
      ServletResponse servletResponse0 = mock(ServletResponse.class, new ViolatedAssumptionAnswer());
      ServletResponseWrapper servletResponseWrapper0 = new ServletResponseWrapper(servletResponse0);
  ...
  */
  ...
  public void test18()  throws Throwable  {
      DefaultWebSecurityManager defaultWebSecurityManager0 = new DefaultWebSecurityManager();
      SimplePrincipalCollection simplePrincipalCollection0 = new SimplePrincipalCollection(defaultWebSecurityManager0, "uoe:IBYjv`;L");
      ServletRequest servletRequest0 = mock(ServletRequest.class, new ViolatedAssumptionAnswer());
